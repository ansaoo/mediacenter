 ...
 */
final class Version20181202213228 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__upload AS SELECT id, filename, file_size, target, original_filename, type, created FROM upload');
        ...
        $this->addSql('INSERT INTO upload (id, filename, file_size, target, original_filename, type, created) SELECT id, filename, file_size, target, original_filename, type, created FROM __temp__upload');
