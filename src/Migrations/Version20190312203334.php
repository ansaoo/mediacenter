 ...
 */
final class Version20190312203334 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE picture (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, exif_id INTEGER DEFAULT NULL, mediainfo_id INTEGER DEFAULT NULL, filename VARCHAR(255) NOT NULL COLLATE BINARY, added DATETIME NOT NULL, created DATETIME DEFAULT NULL, original_filename VARCHAR(255) NOT NULL COLLATE BINARY, status BOOLEAN NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, file_size INTEGER NOT NULL, last_update DATETIME DEFAULT NULL, dc VARCHAR(255) DEFAULT NULL COLLATE BINARY, dc_gif VARCHAR(255) DEFAULT NULL COLLATE BINARY, description VARCHAR(255) DEFAULT NULL COLLATE BINARY, img_height INTEGER DEFAULT NULL, img_width INTEGER DEFAULT NULL, kind VARCHAR(255) DEFAULT NULL COLLATE BINARY, original_url VARCHAR(255) DEFAULT NULL COLLATE BINARY, src VARCHAR(255) DEFAULT NULL COLLATE BINARY, title VARCHAR(255) DEFAULT NULL COLLATE BINARY, t_height VARCHAR(255) DEFAULT NULL COLLATE BINARY, t_width VARCHAR(255) DEFAULT NULL COLLATE BINARY, t_url VARCHAR(255) DEFAULT NULL COLLATE BINARY, type VARCHAR(255) NOT NULL, CONSTRAINT FK_16DB4F89B0FC9251 FOREIGN KEY (exif_id) REFERENCES exif (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_16DB4F8918C1BCA5 FOREIGN KEY (mediainfo_id) REFERENCES media_info (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__picture AS SELECT id, exif_id, mediainfo_id, filename, added, created, original_filename, status, name, file_size, last_update, dc, dc_gif, description, img_height, img_width, kind, original_url, src, title, t_height, t_width, t_url FROM picture');
        $this->addSql('DROP TABLE picture');
        $this->addSql('CREATE TABLE picture (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, exif_id INTEGER DEFAULT NULL, mediainfo_id INTEGER DEFAULT NULL, filename VARCHAR(255) NOT NULL, added DATETIME NOT NULL, created DATETIME DEFAULT NULL, original_filename VARCHAR(255) NOT NULL, status BOOLEAN NOT NULL, name VARCHAR(255) NOT NULL, file_size INTEGER NOT NULL, last_update DATETIME DEFAULT NULL, dc VARCHAR(255) DEFAULT NULL, dc_gif VARCHAR(255) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, img_height INTEGER DEFAULT NULL, img_width INTEGER DEFAULT NULL, kind VARCHAR(255) DEFAULT NULL, original_url VARCHAR(255) DEFAULT NULL, src VARCHAR(255) DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, t_height VARCHAR(255) DEFAULT NULL, t_width VARCHAR(255) DEFAULT NULL, t_url VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO picture (id, exif_id, mediainfo_id, filename, added, created, original_filename, status, name, file_size, last_update, dc, dc_gif, description, img_height, img_width, kind, original_url, src, title, t_height, t_width, t_url) SELECT id, exif_id, mediainfo_id, filename, added, created, original_filename, status, name, file_size, last_update, dc, dc_gif, description, img_height, img_width, kind, original_url, src, title, t_height, t_width, t_url FROM __temp__picture');
        $this->addSql('DROP TABLE __temp__picture');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_16DB4F89B0FC9251 ON picture (exif_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_16DB4F8918C1BCA5 ON picture (mediainfo_id)');
